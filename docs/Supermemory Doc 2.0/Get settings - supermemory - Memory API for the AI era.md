# Get settings - supermemory | Memory API for the AI era

**Source:** https://supermemory.ai/docs/api-reference/organization-settings/get-settings
**Scraped:** 2025-10-08 18:00:43
...
[Search memory entries](/docs/api-reference/search/search-memory-entries)[Update settings](/docs/api-reference/organization-settings/update-settings)
