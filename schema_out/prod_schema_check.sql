...
CREATE TABLE IF NOT EXISTS "public"."tech_levels" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "empire_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."tech_levels" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."tech_levels"
    ADD CONSTRAINT "tech_levels_empire_id_tech_key_key" UNIQUE ("empire_id", "tech_key");
...
CREATE INDEX "idx_tech_levels_empire" ON "public"."tech_levels" USING "btree" ("empire_id");
...
ALTER TABLE ONLY "public"."tech_levels"
    ADD CONSTRAINT "tech_levels_empire_id_fkey" FOREIGN KEY ("empire_id") REFERENCES "public"."empires"("id") ON DELETE CASCADE;
...
GRANT ALL ON TABLE "public"."tech_levels" TO "anon";
GRANT ALL ON TABLE "public"."tech_levels" TO "authenticated";
GRANT ALL ON TABLE "public"."tech_levels" TO "service_role";
