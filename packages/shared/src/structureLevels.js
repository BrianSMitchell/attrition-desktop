...
exports.getStructureCreditCostForLevel = getStructureCreditCostForLevel;
exports.hasCanonicalStructureCostForLevel = hasCanonicalStructureCostForLevel;
 ...
 */
function getStructureCreditCostForLevel(key, level) {
    ...
    if (level === 1) {
        const spec = (0, buildings_1.getBuildingSpec)(key);
 ...
 */
function hasCanonicalStructureCostForLevel(key, level) {
    try {
