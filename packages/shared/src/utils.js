...
exports.generateSystemName = generateSystemName;
exports.generatePlanetName = generatePlanetName;
...
exports.getCoordinatesInRadius = getCoordinatesInRadius;
exports.parseCoord = parseCoord;
exports.formatCoord = formatCoord;
exports.calculateHierarchicalDistance = calculateHierarchicalDistance;
exports.isValidCoordinate = isValidCoordinate;
exports.generateRandomHierarchicalCoordinate = generateRandomHierarchicalCoordinate;
exports.getColonizationCost = getColonizationCost;
 ...
 */
function generateRandomCoordinate(maxX, maxY) {
    return {
 ...
 */
function isWithinBounds(coord, maxX, maxY) {
 ...
 */
function getCoordinatesInRadius(center, radius, maxX, maxY) {
    const coordinates = [];
 ...
 */
function calculateHierarchicalDistance(coord1, coord2) {
 ...
 */
function generateRandomHierarchicalCoordinate(server = 'A') {
    return {
        server,
 ...
 */
function getColonizationCost(baseCount, hasDeletedBase) {
