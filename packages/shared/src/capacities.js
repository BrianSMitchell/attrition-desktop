...
exports.computeConstructionCapacity = computeConstructionCapacity;
exports.computeProductionCapacity = computeProductionCapacity;
exports.computeResearchCapacity = computeResearchCapacity;
exports.computeAllCapacities = computeAllCapacities;
exports.classifyCapacityBreakdown = classifyCapacityBreakdown;
...
// - +5% if 'cybernetics' >= 1
function computeConstructionCapacity(ctx) {
    const breakdown = [];
    // Baseline flat
...
// - +5% if 'cybernetics' >= 1
function computeProductionCapacity(ctx) {
    const breakdown = [];
    // Baseline flat
...
function computeResearchCapacity(ctx) {
    const breakdown = [];
    // Baseline flat
...
function computeAllCapacities(ctx) {
    return {
 ...
 */
function classifyCapacityBreakdown(items = []) {
    const result = {
        baseline: [],
        buildings: [],
        location: [],
