...
exports.CONFIG_KEYS = exports.HOST_VALUES = exports.URL_PATTERNS = exports.TEST_CONFIG_KEYS = exports.DESKTOP_CONFIG_KEYS = exports.SOCKET_CONFIG_KEYS = exports.GAME_CONFIG_KEYS = exports.SERVER_CONFIG_KEYS = exports.LOGGING_CONFIG_KEYS = exports.TLS_CONFIG_KEYS = exports.SECURITY_CONFIG_KEYS = exports.DB_CONFIG_KEYS = exports.API_CONFIG_KEYS = exports.NEXT_CONFIG_KEYS = exports.REACT_CONFIG_KEYS = exports.VITE_CONFIG_KEYS = exports.ENV_VALUES = exports.ENV_VARS = void 0;
...
Object.defineProperty(exports, "ENV_VARS", { enumerable: true, get: function () { return env_vars_1.ENV_VARS; } });
/**
 ...
 */
exports.TEST_CONFIG_KEYS = {
    TEST_ENV: 'testEnv',
    TEST_TIMEOUT: 'testTimeout',
    SETUP_FILES: 'setupFiles',
    COVERAGE: file_paths_1.DIRECTORY_PATHS.COVERAGE,
...
function isValidEnvironment(env) {
    return Object.values(exports.ENV_VALUES).includes(env);
}
/**
 * Helper function to check if running in development
 */
function isDevelopmentEnv(env) {
    return env === exports.ENV_VALUES.DEVELOPMENT || env === exports.ENV_VALUES.LOCAL;
}
/**
 * Helper function to check if running in production
 */
function isProductionEnv(env) {
    return env === exports.ENV_VALUES.PRODUCTION;
}
/**
 * Helper function to check if running in test
 */
function isTestEnv(env) {
    return env === exports.ENV_VALUES.TEST;
}
