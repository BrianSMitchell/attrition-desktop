...
const { StructuresQueue } = require('./dist/models/StructuresQueue');
const { Empire } = require('./dist/models/Empire');
const { CapacityService } = require('./dist/services/capacityService');
