...
/**
 * Tests for HybridGameLoopService.processUnitQueue (capacity-driven unit completion)
 * We call the private method via (hybridGameLoop as any).processUnitQueue() to isolate behavior.
 */
...
describe('HybridGameLoopService.processUnitQueue', () => {
  ...
  it('marks unit queue item completed when empire exists', async () => {
    await (hybridGameLoop as any).processUnitQueue()
